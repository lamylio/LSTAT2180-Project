...
# 10 secondes
CI.iterated = function(sampleFunction, M=10000, M2 = M/100){
  ...
  round(data.frame(low=sample.T.param - quantile(iterated, 1-alpha/2, na.rm = T) * iterated.SE,
             upp=sample.T.param - quantile(iterated, alpha/2, na.rm=T) * iterated.SE, row.names = NULL), opt.digits)
