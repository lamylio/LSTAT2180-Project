...
# !!!!!!!! MAUVAIS  !!!!!!!!!!!!!! # !!!!!!!! MAUVAIS  !!!!!!!!!!!!!!
SE_Tstar <- sd(sample$obs)/sqrt(n) # !!!!!!!! MAUVAIS  !!!!!!!!!!!!!!
# !!!!!!!! MAUVAIS  !!!!!!!!!!!!!! # !!!!!!!! MAUVAIS  !!!!!!!!!!!!!!
CI_st_B <- c(T_p - quantile(StB_distri_of_T, 0.975)*SE_Tstar,T_p - quantile(StB_distri_of_T, 0.025)*SE_Tstar )
CI_st_B
```
### Iterated bootstrap
...
CI_It_st_B <- c(T_p - quantile(It_StB_distri_of_T, 0.975)*It_SE_theta_hat,T_p - 
               quantile(It_StB_distri_of_T, 0.025)*It_SE_theta_hat )
CI_It_st_B
```
...
for (i in 1:B){
  set.seed(i)
  CI.np.basic.resample = sample(sample$obs, 30, T)
